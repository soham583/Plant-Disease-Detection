disease_dic = {
    'Apple: Scab': """ <b>Crop</b>: Apple <br/>Disease: Apple Scab<br/>
        <br/> Cause of disease:
    ...
    'Apple: Cedar Apple Rust': """ <b>Crop</b>: Apple <br/>Disease: Cedar Apple Rust<br/>
        <br/> Cause of disease:
    ...
    'Cherry: Powdery Mildew': """ <b>Crop</b>: Cherry <br/>Disease: Powdery Mildew<br/>
        <br/> Cause of disease:
    ...
    'Corn: Cercospora Leaf Spot': """ <b>Crop</b>: Corn <br/>Disease: Grey Leaf Spot<br/>
        <br/> Cause of disease:
    ...
    'Corn: Common Rust': """ <b>Crop</b>: Corn(maize) <br/>Disease: Common Rust<br/>
        <br/> Cause of disease:
    ...
    'Corn: Northern Leaf Blight': """ <b>Crop</b>: Corn(maize) <br/>Disease: Northern Leaf Blight
        <br/>
        <br/> Cause of disease:
    ...
    'Peach: Bacterial Spot': """ <b>Crop</b>: Peach <br/>Disease: Bacterial Spot<br/>
        <br/> Cause of disease:
    ...
    'Bell Pepper: Bacterial Spot': """ <b>Crop</b>: Pepper <br/>Disease: Bacterial Spot<br/>
        <br/> Cause of disease:
    ...
    'Bell Pepper: Healthy': """ <b>Crop</b>: Pepper <br/>Disease: No disease<br/>
        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!""",
    ...
    'Strawberry: Healthy': """ <b>Crop</b>: Strawberry <br/>Disease: No disease<br/>
        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!""",
    ...
    'Strawberry: Leaf Scorch': """ <b>Crop</b>: Strawberry <br/>Disease: Leaf Scorch<br/>
        <br/> Cause of disease:
    ...
    'Tomato: Spider Mites': """ <b>Crop</b>: Tomato <br/>Disease: Two-spotted spider mite<br/>
        <br/> Cause of disease:
    ...
    'Tomato: Target Spot': """ <b>Crop</b>: Tomato <br/>Disease: Target Spot<br/>
        <br/> Cause of disease:
    ...
    'Tomato: Mosaic Virus': """ <b>Crop</b>: Tomato <br/>Disease: Mosaic Virus<br/>
        <br/> Cause of disease:
